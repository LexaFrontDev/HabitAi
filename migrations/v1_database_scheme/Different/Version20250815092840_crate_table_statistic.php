...
final class Version20250815092840_create_table_statistic extends AbstractMigration
{
    ...
    {
        return 'Создание таблицы statistic для хранения агрегированной статистики привычек и задач';
    }
        ...
        if (!$schema->hasTable('statistic')) {
            $this->addSql('
                CREATE TABLE statistic (
                    ...
                    year VARCHAR(10) NOT NULL COMMENT \'Год статистики (например, 2025)\',
                    statistic JSON NOT NULL COMMENT \'JSON данные статистики по сущности\',
                    ...
                    PRIMARY KEY(id),
                    INDEX IDX_statistic_user_id (user_id),
                    INDEX IDX_statistic_static_id (static_id)
