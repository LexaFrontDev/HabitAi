...
import {RenderStepPropsEdit} from "../../ui/props/Habits/RenderHabits/RenderStepPropsEdit";

export   const renderStepEdit = ({
                                     step,
                                     setStep,
                                     data,
                                     setData,
            ...
            return (
                <div className="modal-content">
                    ...
                    <div className="actions">
                        ...
                        <button id="save" onClick={editHandler}>Сохранить</button>
                    </div>
                </div>
            );
        default:
